...
const searchItems: SearchItem[] = [
  {
    ...
    subtitle: 'ПТ-ПВ, БрОЦС, НП1, ВТ6, Х20Н80, ДПРНМ, Б-2А и другие коды',
    href: '/marki-metallov/rasshifrovki',
    searchText: 'расшифровки обозначения коды состояние поставка точность ПТ-ПВ ПТПВ АТ-АШ-ПО Б-ПВ лист сталь 30ХГСА БрАМц БрБ2 БрКМц БрОФ БрОЦС НП1 НП2 ВТ1 ВТ6 ОТ4 Ц0 Ц1 Х15Н60 Х20Н80 ВА ВАН МВ МЧ ЦрНб ДПРНМ Б2А Б-2А проволока латунь',
  },
